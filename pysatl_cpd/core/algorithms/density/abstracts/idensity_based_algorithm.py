"""
Module containing abstract base class for density-based change point detection algorithms.
"""

__author__ = " Aleksandra Listkova, Vladimir Kutuev, Alexey Tatyanenko"
...
class IDensityBasedAlgorithm(Algorithm):
    @staticmethod
